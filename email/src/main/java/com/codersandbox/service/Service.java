...
public class Service {
    ...
    public ResponseEntity<Map<String, Object>> sendEmail(@RequestBody Map<String, Object> booking) {
        logger.info("Received email notificatio request : {}", booking);
        booking.put("status", "emailsent");
