...
public class Service {
    ...
    public ResponseEntity<Map<String, Object>> sendSms(@RequestBody Map<String, Object> booking) {
        logger.info("Received sms notificatio request : {}", booking);
        booking.put("status", "smssent");
